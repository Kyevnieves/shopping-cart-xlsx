  ...
  /*  navHamburger.addEventListener('click', ()=>{
    ...
    */
    ...
    document.querySelector('.nav-bar-toggler').addEventListener('click', () => {
        ...
        if(html.classList.contains('stopScroll')){
    ...
    btn_filtro.addEventListener('click', ()=>{
        ...
        inputSubCategoria = document.getElementById('subCategorias');
        inputValor = document.getElementById('Valor');
        inputValor.classList.toggle('shake')
        inputCategoria.classList.toggle('shake')
